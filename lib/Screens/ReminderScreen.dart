...
class _ReminderScreenState extends State<ReminderScreen> {
  ...
  final List<Map<String, String>> reminders = [
    {'plantName': 'Calla Lily', 'status': 'completed', 'purchaseDate': '14 days ago'},
    {'plantName': 'Terrarium', 'status': 'in progress', 'purchaseDate': '14 days ago'},
    {'plantName': 'Grey Star Calathea', 'status': 'pending', 'purchaseDate': '14 days ago'},
    {'plantName': 'Dracaena Trifasciata', 'status': 'pending', 'purchaseDate': '14 days ago'},
  ];
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, String>> filteredReminders = selectedFilter == 'All'
        ? reminders
        : reminders.where((reminder) => reminder['status'] == selectedFilter.toLowerCase()).toList();
            ...
            child: ListView(
              children: filteredReminders.map((reminder) {
                return ReminderCard(
                  ...
                  image: 'https://via.placeholder.com/150', // Use a placeholder or image URL
                );
              }).toList(),
            ),
          ),
